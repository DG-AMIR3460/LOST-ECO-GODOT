...
func _register_states() -> void:
	...
	state_machine.register_state("Idle", preload("res://scripts/personaje/estados/IdleState.gd").new())
	state_machine.register_state("Move", preload("res://scripts/personaje/estados/MoveState.gd").new())
	state_machine.register_state("Jump", preload("res://scripts/personaje/estados/JumpState.gd").new())
	state_machine.register_state("Dash", preload("res://scripts/personaje/estados/DashState.gd").new())
	state_machine.register_state("Attack", preload("res://scripts/personaje/estados/AttackState.gd").new())
	state_machine.register_state("Hurt", preload("res://scripts/personaje/estados/HurtState.gd").new())
	state_machine.register_state("Dead", preload("res://scripts/personaje/estados/DeadState.gd").new())
